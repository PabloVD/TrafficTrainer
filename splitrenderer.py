...
def rasterize(parsed, validate):
    ...
    # print(XY.shape,current_valid.shape,agents_valid.shape,agent_type.shape,current_yaw.flatten().shape,agents_ids.shape,GT_XY.shape,future_valid.shape,tracks_to_predict.flatten().shape,YAWS.shape)
