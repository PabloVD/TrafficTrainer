...
def main():
    ...
    trainer = L.Trainer(max_epochs=n_epochs, default_root_dir=save_path, accelerator=DEVICE, callbacks=[checkpoint_callback], devices=devices)#, limit_train_batches=0.1, limit_val_batches=0.1)
